 ...
 */
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } (g.Chart || (g.Chart = {})).Funnel = f() } })(function () {
        ...
        Chart.controllers.funnel = Chart.DatasetController.extend({
          ...
          update: function update(reset) {
            ...
            var dwRatio = bottomWidth / dMax,
                ...
                // NOTE:  Doing the following caused issues when highlighting.
